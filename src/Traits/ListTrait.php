...
namespace ReliqArts\Thujohn\Twitter\Traits;
...
{
    /**
     * Returns all lists the authenticating or specified user subscribes to, including their own. The user is specified
     * using the user_id or screen_name parameters. If no user is given, the authenticating user is used.
     *
     * Parameters :
     * - user_id
     * - screen_name
    ...
    /**
     * Returns a timeline of tweets authored by members of the specified list. Retweets are included by default. Use
     * the include_rts=false parameter to omit retweets.
     *
     * Parameters :
     * - list_id
     * - slug
    ...
    /**
     * Removes the specified member from the list. The authenticated user must be the list’s owner to remove members
     * from the list.
     *
     * Parameters :
     * - list_id
    ...
    /**
     * Returns the lists the specified user has been added to. If user_id or screen_name are not provided the
    ...
    /**
     * Returns the subscribers of the specified list. Private list subscribers will only be shown if the authenticated
    ...
    /**
     * Adds multiple members to a list, by specifying a comma-separated list of member ids or screen names. The
     * authenticated user must own the list to be able to add members to it. Note that lists can’t have more than 5,000
    ...
    /**
     * Returns the members of the specified list. Private list members will only be shown if the authenticated user
    ...
    /**
     * Add a member to a list. The authenticated user must own the list to be able to add members to it. Note that
    ...
    /**
     * Obtain a collection of the lists the specified user is subscribed to, 20 lists per page by default. Does not
    ...
    /**
     * Removes multiple members from a list, by specifying a comma-separated list of member ids or screen names. The
     * authenticated user must own the list to be able to remove members from it. Note that lists can’t have more than
     * 500 members, and you are limited to removing up to 100 members to a list at a time with this method.
     *
     * Parameters :
     * - list_id
     * - slug
    ...
    /**
     * Returns the lists owned by the specified Twitter user. Private lists will only be shown if the authenticated
     * user is also the owner of the lists.
     *
     * Parameters :
     * - user_id
     * - screen_name
