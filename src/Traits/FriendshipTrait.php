...
trait FriendshipTrait
{
    ...
    /**
     * Returns a collection of numeric IDs for every protected user for whom the authenticating user has a pending
     * follow request.
     *
     * Parameters :
     * - cursor
    ...
    /**
     * Returns a cursored collection of user objects for every user the specified user is following (otherwise known as
     * their “friends”).
     *
     * Parameters :
     * - user_id
     ...
     * user_ids provided. Values for connections can be: following, following_requested, followed_by, none, blocking,
     * muting.
     *
     * Parameters :
     * - screen_name
