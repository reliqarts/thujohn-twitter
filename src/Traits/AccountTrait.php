...
trait AccountTrait
{
     ...
     * successful; returns a 401 status code and an error message if not. Use this method to test if supplied user
    ...
    /**
     * Sets some values that users are able to set under the “Account” tab of their settings page. Only the parameters
    ...
    /**
     * Updates the authenticating user’s profile image. Note that this method expects raw multipart data, not a URL to
     * an image.
     *
     * Parameters :
     * - image
    ...
    /**
     * Uploads a profile banner on behalf of the authenticating user. For best results, upload an profile_banner_url
     * node in their Users objects. More information about sizing variations can be found in User Profile Images and
