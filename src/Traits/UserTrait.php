...
trait UserTrait
{
    ...
    /**
     * Returns a variety of information about the user specified by the required user_id or screen_name parameter. The
    ...
    /**
     * Returns a map of the available size variations of the specified user’s profile banner. If the user has not
     * uploaded a profile banner, a HTTP 404 will be served instead. This method can be used instead of string
     ...
     * used in GET users / suggestions / :slug to get the users in that category.
     *
     * Parameters :
     * - lang
     *
    ...
    /**
     * Access the users in a given category of the Twitter suggested user list and return their most recent status if
