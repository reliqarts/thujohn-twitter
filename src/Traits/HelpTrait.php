...
{
    /**
     * Report the specified user as a spam account to Twitter. Additionally performs the equivalent of POST blocks /
    ...
    /**
     * Returns the current configuration used by Twitter including twitter.com slugs which are not usernames, maximum
     * photo resolutions, and t.co URL lengths.
     *
     * @param mixed $parameters
     */
