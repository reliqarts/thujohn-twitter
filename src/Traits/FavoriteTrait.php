...
trait FavoriteTrait
{
    ...
    /**
     * Un-favorites the status specified in the ID parameter as the authenticating user. Returns the un-favorited
    ...
    /**
     * Favorites the status specified in the ID parameter as the authenticating user. Returns the favorite status when
     * successful.
     *
     * Parameters :
     * - id
