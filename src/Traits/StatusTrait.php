...
trait StatusTrait
{
    ...
    /**
     * Returns a collection of the most recent Tweets (truncated by default) posted by the user indicated by the
    ...
    /**
     * Returns a collection of the most recent Tweets (truncated by default) and retweets posted by the authenticating
     * user and the users they follow. The home timeline is central to how most users interact with the Twitter
     * service.
     *
     * Parameters :
     * - count (1-200)
    ...
    /**
     * Updates the authenticating user’s current status and attaches media for upload. In other words, it creates a
     * Tweet with a picture attached. DEPRECATED.
     *
     * Parameters :
     * - status
     * - media[]
     ...
     * will be automatically recognized as an Embedded Tweet when Twitter’s widget JavaScript is included on the page.
     *
     * Parameters :
     * - url
     * - maxwidth (250-550)
    ...
    /**
     * Returns a collection of up to 100 user IDs belonging to users who have retweeted the tweet specified by the id
     * parameter.
     *
     * Parameters :
     * - id
    ...
    /**
     * Returns fully-hydrated tweet objects for up to 100 tweets per request, as specified by comma-separated values
